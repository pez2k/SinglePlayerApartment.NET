...
Public Class SanVitasSt
    ...
    Public Sub New()
        Try
            ...
            Apartment = New Apartment("1561 San Vitas Street Apt. ", "2", 99000)
            Apartment.Name = ReadCfgValue("SanVitasStName", langFile)
            Apartment.Description = ReadCfgValue("SanVitasStDesc", langFile)
            Apartment.Owner = ReadCfgValue("SVSowner", saveFile)
            Apartment.Entrance = New Vector3(-200.6851, 186.0549, 80.50522)
            Apartment.Save = New Vector3(349.9618, -997.4911, -99.1962)
            Apartment.TeleportInside = New Vector3(346.5235, -1002.9012, -99.1962)
            Apartment.TeleportOutside = New Vector3(-205.4685, 184.4087, 80.32763)
            Apartment.ApartmentExit = New Vector3(346.3732, -1013.137, -99.1962)
            Apartment.Wardrobe = New Vector3(350.8938, -993.6076, -99.1961)
            Apartment.GarageEntrance = New Vector3(-205.952, 192.6613, 79.88345)
            Apartment.GarageOutside = New Vector3(-213.1964, 193.2091, 80.66739)
            Apartment.GarageOutHeading = 82.44815
            Apartment.CameraPosition = New Vector3(-227.7641, 201.8866, 86.85343)
            Apartment.CameraRotation = New Vector3(-4.676774, 0, -109.3161)
            Apartment.CameraFOV = 50.0
            Apartment.WardrobeHeading = 200.6809
            Apartment.GaragePath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\san_vitas_st\"
            Apartment.SaveFile = "SVSowner"
            Apartment.PlayerMap = "SanVitasSt"
            Apartment.Interior = New Vector3(343.85, -999.08, -99.198)
            Apartment.Enabled = True

            If ReadCfgValue("SanVitasSt", settingFile) = "Enable" Then
    ...
    Public Sub OnTick()
        Try
            If My.Settings.SanVitasSt = "Enable" Then
                'Enter Apartment
