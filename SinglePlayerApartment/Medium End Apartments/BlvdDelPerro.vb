...
Public Class BlvdDelPerro
    ...
    Public Sub New()
        Try
            Apartment = New Apartment("1115 Boulevard Del Perro Apt. ", "18", 93000)
            Apartment.Name = ReadCfgValue("BlvdDelPerroName", langFile)
            Apartment.Description = ReadCfgValue("BlvdDelPerroDesc", langFile)
            Apartment.Owner = ReadCfgValue("BDPowner", saveFile)
            Apartment.Entrance = New Vector3(-1606.128, -432.6062, 40.43186)
            Apartment.Save = New Vector3(349.9618, -997.4911, -99.1962)
            Apartment.TeleportInside = New Vector3(346.5235, -1002.9012, -99.1962)
            Apartment.TeleportOutside = New Vector3(-1610.868, -428.8814, 40.46698)
            Apartment.ApartmentExit = New Vector3(346.3732, -1013.137, -99.1962)
            Apartment.Wardrobe = New Vector3(350.8938, -993.6076, -99.1961)
            Apartment.GarageEntrance = New Vector3(-1608.53, -451.0937, 37.58678)
            Apartment.GarageOutside = New Vector3(-1611.859, -454.9521, 37.49269)
            Apartment.GarageOutHeading = 138.179
            Apartment.CameraPosition = New Vector3(-1643.548, -435.6621, 41.09145)
            Apartment.CameraRotation = New Vector3(8.244346, 0, -86.32664)
            Apartment.CameraFOV = 50.0
            Apartment.WardrobeHeading = 200.6809
            Apartment.GaragePath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\blvd_del_perro\"
            Apartment.SaveFile = "BDPowner"
            Apartment.PlayerMap = "BlvdDelPerro"
            Apartment.Interior = New Vector3(343.85, -999.08, -99.198)
            Apartment.Enabled = True

            If ReadCfgValue("BlvdDelPerro", settingFile) = "Enable" Then
    ...
    Public Sub OnTick()
        Try
            If My.Settings.BlvdDelPerro = "Enable" Then
                'Enter Apartment
