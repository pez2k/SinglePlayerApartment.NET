...
Public Class SpanishAve
    ...
    Public Sub New()
        Try
            ...
            Apartment = New Apartment("0605 Spanish Avenue Apt. ", "1", 128000)
            Apartment.Name = ReadCfgValue("SpanishAveName", langFile)
            Apartment.Description = ReadCfgValue("SpanishAveDesc", langFile)
            Apartment.Owner = ReadCfgValue("SAonwer", saveFile)
            Apartment.Entrance = New Vector3(3.602079, 37.2024, 71.53042)
            Apartment.Save = New Vector3(349.9618, -997.4911, -99.1962)
            Apartment.TeleportInside = New Vector3(346.5235, -1002.9012, -99.1962)
            Apartment.TeleportOutside = New Vector3(2.387458, 34.19853, 71.16882)
            Apartment.ApartmentExit = New Vector3(346.3732, -1013.137, -99.1962)
            Apartment.Wardrobe = New Vector3(350.8938, -993.6076, -99.1961)
            Apartment.GarageEntrance = New Vector3(-11.9249, 37.897, 71.08931)
            Apartment.GarageOutside = New Vector3(-12.86958, 35.41181, 71.03293)
            Apartment.GarageOutHeading = 158.7376
            Apartment.CameraPosition = New Vector3(-23.84228, 11.21701, 74.10461)
            Apartment.CameraRotation = New Vector3(10.09729, 0, -29.36126)
            Apartment.CameraFOV = 50.0
            Apartment.WardrobeHeading = 200.6809
            Apartment.GaragePath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\spanish_ave\"
            Apartment.SaveFile = "SAonwer"
            Apartment.PlayerMap = "SpanishAve"
            Apartment.Interior = New Vector3(343.85, -999.08, -99.198)
            Apartment.Enabled = True

            If ReadCfgValue("SpanishAve", settingFile) = "Enable" Then
    ...
    Public Shared Sub CreateSpanishAve()
    ...
    Public Sub OnTick()
        Try
            If My.Settings.SpanishAve = "Enable" Then
                'Enter Apartment
