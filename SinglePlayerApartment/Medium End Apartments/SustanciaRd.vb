...
Public Class SustanciaRd
    ...
    Public Sub New()
        Try
            ...
            Apartment = New Apartment("Sustancia Road ", "12", 143000)
            Apartment.Name = ReadCfgValue("SustanciaRdName", langFile)
            Apartment.Description = ReadCfgValue("SustanciaRdDesc", langFile)
            Apartment.Owner = ReadCfgValue("SRowner", saveFile)
            Apartment.Entrance = New Vector3(1341.38, -1577.858, 54.44421)
            Apartment.Save = New Vector3(349.9618, -997.4911, -99.1962)
            Apartment.TeleportInside = New Vector3(346.5235, -1002.9012, -99.1962)
            Apartment.TeleportOutside = New Vector3(1344.532, -1581.023, 54.05513)
            Apartment.ApartmentExit = New Vector3(346.3732, -1013.137, -99.1962)
            Apartment.Wardrobe = New Vector3(350.8938, -993.6076, -99.1961)
            Apartment.GarageEntrance = New Vector3(1351.739, -1574.466, 53.83353)
            Apartment.GarageOutside = New Vector3(1354.933, -1578.982, 53.38385)
            Apartment.GarageOutHeading = 216.5491
            Apartment.CameraPosition = New Vector3(1357.432, -1594.719, 53.01324)
            Apartment.CameraRotation = New Vector3(3.356584, 0, 35.79725)
            Apartment.CameraFOV = 50.0
            Apartment.WardrobeHeading = 200.6809
            Apartment.GaragePath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\sustancia_rd\"
            Apartment.SaveFile = "SRowner"
            Apartment.PlayerMap = "SustanciaRd"
            Apartment.Interior = New Vector3(343.85, -999.08, -99.198)
            Apartment.Enabled = True

            If ReadCfgValue("SustanciaRd", settingFile) = "Enable" Then
    ...
    Public Sub OnTick()
        Try
            If My.Settings.SustanciaRd = "Enable" Then
                'Enter Apartment
