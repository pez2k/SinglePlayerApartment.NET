...
Public Class SouthMoMiltonDr
    ...
    Public Sub New()
        Try
            ...
            Apartment = New Apartment("0504 South Mo Milton Drive Apt. ", "1", 141000)
            Apartment.Name = ReadCfgValue("SouthMoMiltonName", langFile)
            Apartment.Description = ReadCfgValue("SouthMoMiltonDesc", langFile)
            Apartment.Owner = ReadCfgValue("SMMowner", saveFile)
            Apartment.Entrance = New Vector3(-627.7245, 169.6668, 61.16204)
            Apartment.Save = New Vector3(349.9618, -997.4911, -99.1962)
            Apartment.TeleportInside = New Vector3(346.5235, -1002.9012, -99.1962)
            Apartment.TeleportOutside = New Vector3(-633.7015, 169.4392, 61.22641)
            Apartment.ApartmentExit = New Vector3(346.3732, -1013.137, -99.1962)
            Apartment.Wardrobe = New Vector3(350.8938, -993.6076, -99.1961)
            Apartment.GarageEntrance = New Vector3(-630.657, 152.3768, 56.41848)
            Apartment.GarageOutside = New Vector3(-638.4281, 152.3656, 57.24699)
            Apartment.GarageOutHeading = 89.08953
            Apartment.CameraPosition = New Vector3(-663.4779, 162.9781, 62.82269)
            Apartment.CameraRotation = New Vector3(7.656792, 0, -92.89036)
            Apartment.CameraFOV = 50.0
            Apartment.WardrobeHeading = 200.6809
            Apartment.GaragePath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\south_mo_milton_dr\"
            Apartment.SaveFile = "SMMowner"
            Apartment.PlayerMap = "SouthMoMiltonDr"
            Apartment.Interior = New Vector3(343.85, -999.08, -99.198)
            Apartment.Enabled = True

            If ReadCfgValue("SouthMoMiltonDr", settingFile) = "Enable" Then
    ...
    Public Shared Sub CreateSouthMoMiltonDr()
    ...
    Public Sub OnTick()
        Try
            If My.Settings.SouthMoMiltonDr = "Enable" Then
                'Enter Apartment
