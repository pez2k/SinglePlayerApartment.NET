...
Public Class SouthRockfordDrive0325
    ...
    Public Sub New()
        Try
            ...
            Apartment = New Apartment("0325 South Rockford Drive Apt. ", "1", 137000)
            Apartment.Name = ReadCfgValue("0325SouthRockfordName", langFile)
            Apartment.Description = ReadCfgValue("0325SouthRockfordDesc", langFile)
            Apartment.Owner = ReadCfgValue("0325SRDowner", saveFile)
            Apartment.Entrance = New Vector3(-831.4216, -862.641, 20.68967)
            Apartment.Save = New Vector3(349.9618, -997.4911, -99.1962)
            Apartment.TeleportInside = New Vector3(346.5235, -1002.9012, -99.1962)
            Apartment.TeleportOutside = New Vector3(-831.6166, -856.5034, 19.59702)
            Apartment.ApartmentExit = New Vector3(346.3732, -1013.137, -99.1962)
            Apartment.Wardrobe = New Vector3(350.8938, -993.6076, -99.1961)
            Apartment.GarageEntrance = New Vector3(-758.8065, -870.7308, 20.9393)
            Apartment.GarageOutside = New Vector3(-755.0645, -870.7145, 21.18062)
            Apartment.GarageOutHeading = 267.8936
            Apartment.CameraPosition = New Vector3(-846.1815, -821.6712, 21.12708)
            Apartment.CameraRotation = New Vector3(9.139385, 0, -142.4772)
            Apartment.CameraFOV = 50.0
            Apartment.WardrobeHeading = 200.6809
            Apartment.GaragePath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0325_south_rockford_dr\"
            Apartment.SaveFile = "0325SRDowner"
            Apartment.PlayerMap = "0325SouthRockfordDr"
            Apartment.Interior = New Vector3(343.85, -999.08, -99.198)
            Apartment.Enabled = True

            If ReadCfgValue("0325SouthRockfordDr", settingFile) = "Enable" Then
    ...
    Public Shared Sub Create0325SouthRockfordDr()
    ...
    Public Sub OnTick()
        Try
            If My.Settings.SouthRockfordDr0325 = "Enable" Then
                'Enter Apartment
