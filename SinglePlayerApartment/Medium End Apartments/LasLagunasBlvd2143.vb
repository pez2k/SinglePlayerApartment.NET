...
Public Class LasLagunasBlvd2143
    ...
    Public Sub New()
        Try
            ...
            Apartment.TeleportOutside = New Vector3(-44.99031, -60.94749, 63.58578)
            Apartment.ApartmentExit = New Vector3(346.3732, -1013.137, -99.1962)
            Apartment.Wardrobe = New Vector3(350.8938, -993.6076, -99.1961)
            Apartment.GarageEntrance = New Vector3(-32.13178, -69.51645, 58.91152)
            Apartment.GarageOutside = New Vector3(-40.82223, -67.3935, 58.69315)
            Apartment.GarageOutHeading = 69.59575
            Apartment.CameraPosition = New Vector3(-76.6449, -41.96963, 63.77706)
            Apartment.CameraRotation = New Vector3(4.850093, 0, -106.2234)
            Apartment.CameraFOV = 50.0
            Apartment.WardrobeHeading = 200.6809
            Apartment.GaragePath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\2143_las_lagunas_blvd\"
            Apartment.SaveFile = "2143LLBowner"
            Apartment.PlayerMap = "2143LasLagunasBlvd"
