...
Public Class TheRoyale
    ...
    Public Sub New()
        Try
            ...
            Apartment.TeleportOutside = New Vector3(-197.6289, 90.04182, 69.65993)
            Apartment.ApartmentExit = New Vector3(346.3732, -1013.137, -99.1962)
            Apartment.Wardrobe = New Vector3(350.8938, -993.6076, -99.1961)
            Apartment.GarageEntrance = New Vector3(-212.6948, 73.81252, 66.74328)
            Apartment.GarageOutside = New Vector3(-215.8855, 75.07529, 66.78372)
            Apartment.GarageOutHeading = 81.58614
            Apartment.CameraPosition = New Vector3(-194.8486, 123.9623, 71.46825)
            Apartment.CameraRotation = New Vector3(1.435651, 0, -168.6253)
            Apartment.CameraFOV = 50.0
            Apartment.WardrobeHeading = 200.6809
            Apartment.GaragePath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\the_royale\"
            Apartment.SaveFile = "TRowner"
            Apartment.PlayerMap = "TheRoyale"
            Apartment.Interior = New Vector3(343.85, -999.08, -99.198)
            Apartment.Enabled = True

            If ReadCfgValue("TheRoyale", settingFile) = "Enable" Then
