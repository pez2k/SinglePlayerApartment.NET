...
Public Class PowerSt
    ...
    Public Sub New()
        Try
            ...
            Apartment.TeleportOutside = New Vector3(282.245, -159.5781, 63.62236)
            Apartment.ApartmentExit = New Vector3(346.3732, -1013.137, -99.1962)
            Apartment.Wardrobe = New Vector3(350.8938, -993.6076, -99.1961)
            Apartment.GarageEntrance = New Vector3(281.59, -146.9051, 64.62709)
            Apartment.GarageOutside = New Vector3(271.4526, -143.1953, 64.92351)
            Apartment.GarageOutHeading = 71.11879
            Apartment.CameraPosition = New Vector3(247.5116, -143.1925, 67.63675)
            Apartment.CameraRotation = New Vector3(1.717242, 0, -99.06012)
            Apartment.CameraFOV = 50.0
            Apartment.WardrobeHeading = 200.6809
            Apartment.GaragePath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\power_st\"
            Apartment.SaveFile = "PSowner"
            Apartment.PlayerMap = "PowerSt"
            Apartment.Interior = New Vector3(343.85, -999.08, -99.198)
            Apartment.Enabled = True

            If ReadCfgValue("PowerSt", settingFile) = "Enable" Then
    ...
    Public Shared Sub CreatePowerSt()
