...
Public Class ProsperitySt
    ...
    Public Sub New()
        Try
            Apartment = New Apartment("1237 Prosperity Street Apt. ", "21", 105000)
            Apartment.Name = ReadCfgValue("ProsperityStName", langFile)
            Apartment.Description = ReadCfgValue("ProsperityStDesc", langFile)
            Apartment.Owner = ReadCfgValue("PPSowner", saveFile)
            Apartment.Entrance = New Vector3(-1564.456, -406.2599, 42.38398)
            Apartment.Save = New Vector3(349.9618, -997.4911, -99.1962)
            Apartment.TeleportInside = New Vector3(346.5235, -1002.9012, -99.1962)
            Apartment.TeleportOutside = New Vector3(-1562.17, -408.0945, 42.38398)
            Apartment.ApartmentExit = New Vector3(346.3732, -1013.137, -99.1962)
            Apartment.Wardrobe = New Vector3(350.8938, -993.6076, -99.1961)
            Apartment.GarageEntrance = New Vector3(-1554.318, -402.5234, 41.53171)
            Apartment.GarageOutside = New Vector3(-1548.194, -407.8083, 41.50047)
            Apartment.GarageOutHeading = 228.1096
            Apartment.CameraPosition = New Vector3(-1510.861, -407.8669, 42.94849)
            Apartment.CameraRotation = New Vector3(6.705585, 0, 82.56407)
            Apartment.CameraFOV = 50.0
            Apartment.WardrobeHeading = 200.6809
            Apartment.GaragePath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\prosperity_st\"
            Apartment.SaveFile = "PPSowner"
            Apartment.PlayerMap = "ProsperitySt"
            Apartment.Interior = New Vector3(343.85, -999.08, -99.198)
            Apartment.Enabled = True

            If ReadCfgValue("ProsperitySt", settingFile) = "Enable" Then
    ...
    Public Sub OnTick()
        Try
            If My.Settings.ProsperitySt = "Enable" Then
                'Enter Apartment
