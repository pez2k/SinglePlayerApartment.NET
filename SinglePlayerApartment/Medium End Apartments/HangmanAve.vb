...
Public Class HangmanAve
    ...
    Public Sub New()
        Try
            ...
            Apartment = New Apartment("Hangman Avenue ", "4", 175000)
            Apartment.Name = ReadCfgValue("HangmanAveName", langFile)
            Apartment.Description = ReadCfgValue("HangmanAveDesc", langFile)
            Apartment.Owner = ReadCfgValue("HAowner", saveFile)
            Apartment.Entrance = New Vector3(-1405.445, 526.9388, 123.8313)
            Apartment.Save = New Vector3(349.9618, -997.4911, -99.1962)
            Apartment.TeleportInside = New Vector3(346.5235, -1002.9012, -99.1962)
            Apartment.TeleportOutside = New Vector3(-1406.652, 533.3694, 122.9286)
            Apartment.ApartmentExit = New Vector3(346.3732, -1013.137, -99.1962)
            Apartment.Wardrobe = New Vector3(350.8938, -993.6076, -99.1961)
            Apartment.GarageEntrance = New Vector3(-1409.864, 540.1284, 122.5761)
            Apartment.GarageOutside = New Vector3(-1421.402, 535.7197, 120.7177)
            Apartment.GarageOutHeading = 111.9388
            Apartment.CameraPosition = New Vector3(-1437.455, 533.4254, 122.9885)
            Apartment.CameraRotation = New Vector3(-4.026862, 0, -94.79375)
            Apartment.CameraFOV = 50.0
            Apartment.WardrobeHeading = 200.6809
            Apartment.GaragePath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\hangman_ave\"
            Apartment.SaveFile = "HAowner"
            Apartment.PlayerMap = "HangmanAve"
            Apartment.Interior = New Vector3(343.85, -999.08, -99.198)
            Apartment.Enabled = True

            If ReadCfgValue("HangmanAve", settingFile) = "Enable" Then
    ...
    Public Sub OnTick()
        Try
            If My.Settings.HangmanAve = "Enable" Then
                'Enter Apartment
