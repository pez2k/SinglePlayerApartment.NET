...
Public Class CougarAve
    ...
    Public Sub New()
        Try
            ...
            Apartment.TeleportOutside = New Vector3(-1535.237, -325.281, 47.48159)
            Apartment.ApartmentExit = New Vector3(346.3732, -1013.137, -99.1962)
            Apartment.Wardrobe = New Vector3(350.8938, -993.6076, -99.1961)
            Apartment.GarageEntrance = New Vector3(-1530.807, -346.3962, 44.66446)
            Apartment.GarageOutside = New Vector3(-1536.455, -352.6137, 44.54288)
            Apartment.GarageOutHeading = 135.3604
            Apartment.CameraPosition = New Vector3(-1563.921, -321.3005, 51.06629)
            Apartment.CameraRotation = New Vector3(-4.889933, 0, -100.0785)
            Apartment.CameraFOV = 50.0
            Apartment.WardrobeHeading = 200.6809
            Apartment.GaragePath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\cougar_ave\"
            Apartment.SaveFile = "CAowner"
            Apartment.PlayerMap = "CougarAve"
            Apartment.Interior = New Vector3(343.85, -999.08, -99.198)
            Apartment.Enabled = True

            If ReadCfgValue("CougarAve", settingFile) = "Enable" Then
    ...
    Public Shared Sub CreateCougarAve()
