...
Public Class ProcopioDr4401
    ...
    Public Sub New()
        Try
            Apartment = New Apartment("Procopio Drive ", "4401", 165000)
            Apartment.Name = ReadCfgValue("4401ProcopioDrName", langFile)
            Apartment.Description = ReadCfgValue("4401ProcopioDrDesc", langFile)
            Apartment.Owner = ReadCfgValue("4401PDowner", saveFile)
            Apartment.Entrance = New Vector3(-302.2182, 6327.001, 32.88741)
            Apartment.Save = New Vector3(349.9618, -997.4911, -99.1962)
            Apartment.TeleportInside = New Vector3(346.5235, -1002.9012, -99.1962)
            Apartment.TeleportOutside = New Vector3(-305.5824, 6330.911, 32.48935)
            Apartment.ApartmentExit = New Vector3(346.3732, -1013.137, -99.1962)
            Apartment.Wardrobe = New Vector3(350.8938, -993.6076, -99.1961)
            Apartment.GarageEntrance = New Vector3(-294.8063, 6338.88, 32.00024)
            Apartment.GarageOutside = New Vector3(-296.2461, 6340.683, 31.76276)
            Apartment.GarageOutHeading = 44.08249
            Apartment.CameraPosition = New Vector3(-304.3051, 6344.134, 33.43044)
            ...
            If ReadCfgValue("4401ProcopioDr", settingFile) = "Enable" Then
    ...
    Public Sub OnTick()
        Try
            If My.Settings.ProcopioDr4401 = "Enable" Then
                'Enter Apartment
