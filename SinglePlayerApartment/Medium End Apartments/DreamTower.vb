...
Public Class DreamTower
    ...
    Public Sub New()
        Try
            ...
            Apartment.TeleportOutside = New Vector3(-757.82， -753.8024， 26.6554)
            Apartment.ApartmentExit = New Vector3(346.3732, -1013.137, -99.1962)
            Apartment.Wardrobe = New Vector3(350.8938, -993.6076, -99.1961)
            Apartment.GarageEntrance = New Vector3(-787.0813, -801.8603, 20.6192)
            Apartment.GarageOutside = New Vector3(-789.551, -815.7581, 20.1855)
            Apartment.GarageOutHeading = 181.6813
            Apartment.CameraPosition = New Vector3(-730.9564， -866.194， 39.5012)
