...
Public Class MiltonRd0184
    ...
    Public Sub New()
        Try
            ...
            Apartment = New Apartment("0184 Milton Road Apt. ", "13", 146000)
            Apartment.Name = ReadCfgValue("MiltonRdName", langFile)
            Apartment.Description = ReadCfgValue("MiltonRdDesc", langFile)
            Apartment.Owner = ReadCfgValue("0184MRowner", saveFile)
            Apartment.Entrance = New Vector3(-511.7496, 108.2573, 63.80054)
            Apartment.Save = New Vector3(349.9618, -997.4911, -99.1962)
            Apartment.TeleportInside = New Vector3(346.5235, -1002.9012, -99.1962)
            Apartment.TeleportOutside = New Vector3(-512.2141, 111.8229, 63.33881)
            Apartment.ApartmentExit = New Vector3(346.3732, -1013.137, -99.1962)
            Apartment.Wardrobe = New Vector3(350.8938, -993.6076, -99.1961)
            Apartment.GarageEntrance = New Vector3(-521.9894, 92.31882, 59.75345)
            Apartment.GarageOutside = New Vector3(-536.3447, 92.78167, 60.42566)
            Apartment.GarageOutHeading = 87.18483
            Apartment.CameraPosition = New Vector3(-526.9971, 133.2838, 65.28127)
            Apartment.CameraRotation = New Vector3(5.028964, 0, -148.544)
            Apartment.CameraFOV = 50.0
            Apartment.WardrobeHeading = 200.6809
            Apartment.GaragePath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0184_milton_road\"
            Apartment.SaveFile = "0184MRowner"
            Apartment.PlayerMap = "0184MiltonRd"
            Apartment.Interior = New Vector3(343.85, -999.08, -99.198)
            Apartment.Enabled = True

            If ReadCfgValue("0184MiltonRd", settingFile) = "Enable" Then
    ...
    Public Sub OnTick()
        Try
            If My.Settings.MiltonRd0184 = "Enable" Then
                'Enter Apartment
