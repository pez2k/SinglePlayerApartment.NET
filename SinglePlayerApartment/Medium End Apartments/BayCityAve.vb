...
Public Class BayCityAve
    ...
    Public Sub New()
        Try
            ...
            Apartment.TeleportOutside = New Vector3(-974.1464, -1433.113, 7.679172)
            Apartment.ApartmentExit = New Vector3(346.3732, -1013.137, -99.1962)
            Apartment.Wardrobe = New Vector3(350.8938, -993.6076, -99.1961)
            Apartment.GarageEntrance = New Vector3(-982.9502, -1450.931, 4.38989)
            Apartment.GarageOutside = New Vector3(-993.4175, -1425.568, 4.386545)
            Apartment.GarageOutHeading = 107.4124
            Apartment.CameraPosition = New Vector3(-1012.979, -1429.618, 6.07423)
            Apartment.CameraRotation = New Vector3(9.87174, 0, -98.14085)
            Apartment.CameraFOV = 50.0
            Apartment.WardrobeHeading = 200.6809
            Apartment.GaragePath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\bay_city_ave\"
            Apartment.SaveFile = "BCAowner"
            Apartment.PlayerMap = "BayCityAve"
            Apartment.Interior = New Vector3(343.85, -999.08, -99.198)
            Apartment.Enabled = True

            If ReadCfgValue("BayCityAve", settingFile) = "Enable" Then
