...
Public Class LasLagunasBlvd0604
    ...
    Public Sub New()
        Try
            ...
            Apartment = New Apartment("0604 Las Lagunas Boulevard Apt. ", "4", 126000)
            Apartment.Name = ReadCfgValue("0604LasLagunasName", langFile)
            Apartment.Description = ReadCfgValue("0604LasLagunasDesc", langFile)
            Apartment.Owner = ReadCfgValue("0604LLBowner", saveFile)
            Apartment.Entrance = New Vector3(9.446668, 81.46045, 78.43513)
            Apartment.Save = New Vector3(349.9618, -997.4911, -99.1962)
            Apartment.TeleportInside = New Vector3(346.5235, -1002.9012, -99.1962)
            Apartment.TeleportOutside = New Vector3(10.9781, 86.45157, 78.39816)
            Apartment.ApartmentExit = New Vector3(346.3732, -1013.137, -99.1962)
            Apartment.Wardrobe = New Vector3(350.8938, -993.6076, -99.1961)
            Apartment.GarageEntrance = New Vector3(27.83206, 80.46669, 74.25099)
            Apartment.GarageOutside = New Vector3(39.44078, 77.11552, 74.9635)
            Apartment.GarageOutHeading = 241.9727
            Apartment.CameraPosition = New Vector3(-31.15757, 105.2271, 81.74537)
            Apartment.CameraRotation = New Vector3(6.371637, 0, -137.1451)
            Apartment.CameraFOV = 50.0
            Apartment.WardrobeHeading = 200.6809
            Apartment.GaragePath = Application.StartupPath & "\scripts\SinglePlayerApartment\Garage\0604_las_lagunas_blvd\"
            Apartment.SaveFile = "0604LLBowner"
            Apartment.PlayerMap = "0604LasLagunasBlvd"
            Apartment.Interior = New Vector3(343.85, -999.08, -99.198)
            Apartment.Enabled = True

            If ReadCfgValue("0604LasLagunasBlvd", settingFile) = "Enable" Then
    ...
    Public Shared Sub Create0604LasLagunasBlvd()
    ...
    Public Sub OnTick()
        Try
            If My.Settings.LasLagunasBlvd0604 = "Enable" Then
                'Enter Apartment
