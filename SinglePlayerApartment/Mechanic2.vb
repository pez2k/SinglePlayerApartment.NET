...
Public Class Mechanic2
    ...
    Public Shared Sub ReturnVeh(PathDir As String)
        ...
        For i = 0 To 9
            If IO.File.Exists(PathDir & "vehicle_" + i.ToString() + ".cfg") Then
                WriteCfgValue("Active", "False", PathDir & "vehicle_" + i.ToString() + ".cfg")
            End If
        Next
    ...
    Public Shared Sub SetModKit(_Vehicle As Vehicle, VehicleCfgFile As String)
        ...
        If ReadCfgBool("HasCustomPrimaryColor", VehicleCfgFile) Then _Vehicle.CustomPrimaryColor = Color.FromArgb(ReadCfgValue("CustomPrimaryColorRed", VehicleCfgFile), ReadCfgValue("CustomPrimaryColorGreen", VehicleCfgFile), ReadCfgValue("CustomPrimaryColorBlue", VehicleCfgFile))
        If ReadCfgBool("HasCustomSecondaryColor", VehicleCfgFile) Then _Vehicle.CustomSecondaryColor = Color.FromArgb(ReadCfgValue("CustomSecondaryColorRed", VehicleCfgFile), ReadCfgValue("CustomSecondaryColorGreen", VehicleCfgFile), ReadCfgValue("CustomSecondaryColorBlue", VehicleCfgFile))
