...
Public Class Z
    ...
    Public Sub New()
        Try
            ...
            If ReadCfgValue("2044NorthConker", settingFile) = "Enable" Then NorthConker2044.CreateApartment()
            If ReadCfgValue("2862Hillcrest", settingFile) = "Enable" Then HillcrestAve2862.CreateApartment()
            If ReadCfgValue("2868Hillcrest", settingFile) = "Enable" Then HillcrestAve2868.CreateApartment()
            If ReadCfgValue("3655WildOats", settingFile) = "Enable" Then WildOats3655.CreateApartment()
            If ReadCfgValue("2045NorthConker", settingFile) = "Enable" Then NorthConker2045.CreateApartment()
            If ReadCfgValue("2117MiltonRd", settingFile) = "Enable" Then MiltonRd2117.CreateApartment()
            If ReadCfgValue("2874Hillcrest", settingFile) = "Enable" Then HillcrestAve2874.CreateApartment()
            If ReadCfgValue("3677Whispymound", settingFile) = "Enable" Then Whispymound3677.CreateApartment()
            If ReadCfgValue("2113MadWayne", settingFile) = "Enable" Then MadWayne2113.CreateApartment()
